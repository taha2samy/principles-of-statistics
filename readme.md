...
المتغيرات من نوع النسبة تتضمن القياسات التي يمكن قياسها باستخدام الأعداد الحقيقية وتحتوي على علاقة نسبية محددة. على سبيل المثال:

- الوزن: يمكن قياس الوزن بالكيلوجرام أو الجرامات.
- الطول: يمكن قياس الطول بالمتر أو السنتيمترات.
- الزمن: يمكن قياس الزمن بالساعات والدقائق والثواني.
- السرعة: يمكن قياس السرعة بالكيلومترات في الساعة أو الميل في الساعة.
- الإيرادات: يمكن قياس الإيرادات بالعملة المحلية أو الدولارات.

##### الفرق (Interval)

المتغيرات من نوع الفرق تشابه المتغيرات من نوع النسبة، ولكنها تختلف في عدم وجود قيمة معيارية للصفر المطلق. على سبيل المثال:

- درجات الحرارة: يمكن قياس درجات الحرارة بالمؤشرات المئوية والفهرنهايت، ولكن لا يوجد صفر مطلق للحرارة.
